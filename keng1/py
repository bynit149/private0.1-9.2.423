...
#ki2 = LINETCR.LINE()
#ki2.login(token="EpvzCrbYDiapL46qXeZf.Uo55pvGA4YpeNP2VY//qtW.CQygQrsBWrUwamBM61Zc5HO3d0CjKq5t5oj0xg/hnEQ=")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="EpjRjf8G35MOC3aHbRWf.OPdMEHv+nwMNFrcrrPK8hW.m3elyHccPIjqRj6vpCShHq20fscDn4r2Qip+18XPgoc=")
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token="EprjgD9lAVGSEcHhEfB9.jlsR0/a3WnhuamX4hH3KQq.6kPCo/69hheUK9GNqM9bUi+/sPxa8eyOEUnsxjU3TU4=")
#ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="Ep4IcC8azG5ispPUoFZc.QModQeCjX2N8N/0LDCNd+a.FX60m7Vw4t2eYOPTnNwVl4d3127QdXq5YMCDIRbLeP4=")
#ki5.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["เดี๋ยวมา"]
                     ret_ = "เรียกทำไม   " + random.choice(balas)
