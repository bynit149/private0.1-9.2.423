...
ki1 = LINETCR.LINE()
ki1.login(token="EpNIy6ZUdjWL8YH35Oa9.glvUGMKIz5ylyjKrZRIckq.4/ih8MhJZ0jkosPTctkyLgGQXj7o0m74SjLCO7Kb8lE=")
ki1.loginResult()
...
#ki6 = LINETCR.LINE()
#ki6.login(token="EpNIy6ZUdjWL8YH35Oa9.glvUGMKIz5ylyjKrZRIckq.4/ih8MhJZ0jkosPTctkyLgGQXj7o0m74SjLCO7Kb8lE=")
#ki6.loginResult()

#ki7 = LINETCR.LINE()
#ki7.login(token="EpmyBctQlxC24mGIVwLa.gTcG3a066nCBC02KOU2wEG.lIR/HkAF77uozd9q6fWWMWXynT/sRQ9Ms8fTbpTDl8Q=")
#ki7.loginResult()

#ki8 = LINETCR.LINE()
#ki8.login(token="Epj9kBuoYkPptKzG3Bi3.iZGepSr4S3ocUb9d+YflyW.meEGA0EMuzF+lMD9A6SnSB98btcLLUs0S33X7b7JWQA=")
#ki8.loginResult()

#ki9 = LINETCR.LINE()
#ki9.login(token="EpKSaaZ0jXVGtwWNlpFc.fViUrRyK4mVvOBQlBiIQ7a.tzMd7kF2OrY29fJDhgJ97jNQhmvcUxWJqTlxECOTPwI=")
#ki9.loginResult()

#ki10 = LINETCR.LINE()
#ki10.login(token="Epn1ucwxVxRFn7yvCHM9.QqUY5RXmnjX22QWyhYRVYq.D+XK+sBje5I3oe0tZo20f9Du6Jpk3iEOEKt5BfR3g5Y=")
#ki10.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""     ™ചচ✾ъπ່७✾ざণاعနัю❍ีざန
...
║✰ โม่ๆ ➠เรียกคิกเกอร์
║✰ ออก ➠ไล่คิกเกอร์ออก
║✰ ปิดป้องกันหมด ➠ปิดไม่ให้ป้องกันอะไรเลย
║✰ ป้องกันหมด ➠เปิดระบบป้องกันทั้งหมด
║✰ ไอดี ➠ไอดีตัวเอง
║✰ คท ➠คอทแทคตัวเอง
║✰ นับ ➠ระบบเริ่มนับคนอ่าน
║✰ อ่าน ➠แสดงผลคนอ่าน
...
║✰ ลบรัน ➠ลบห้องโดนรัน
║✰ เตะ @ ➠สั่งคิกเกอร์เตะคน
║✰ เตะแม่ง ➠สั่งคิกเกอร์บินห้อง
║✰ มึงตาย/() ➠แอนดรอยจะค้าง เด้งออก‼️‼️‼
╚══════════════════════
"""
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nแทคให้แล้วน่าาาา\nโอเคนะคร้าาาา"]
                     ret_ = "มาแล้วจร้าาา  " + random.choice(balas)
...
#----------------------------------------------------------------------------
            ...
            elif msg.text in ["เช็คแอด","เชคแอด"]:
                try:
                    group = cl.getGroup(msg.to)
...
#==================================================
            ...
            elif msg.text in ["มาหำ","#Kicker","#kicker","Kicker","kicker","•••","คิกมา","หำมา","โม่ๆ"]:
...
#==============================================================================#
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        print zxc
                        msg.text = xpesan+ zxc + "\nLooking: %H\nCurrent time: %H"%(wait2['setTime'][msg.to],datetime.now().strtime('%H:%M:%S'))
